...
router.post('/register', authLimiter, async (req, res) => {
  try {
    const { name, email, password, phone, role, services, serviceDetails, hourlyRate, pricingType, rates, eventOptions, location, country, bio, profileImage, verifyMethod } = req.body;
    ...
    const user = new User({
      ...
      serviceDetails: role === 'provider' ? serviceDetails : undefined,
